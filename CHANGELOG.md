...
- `/coach:exercise` and `/coach:gym` — teach the coach an exercise or a
  ...
  guarded writer.
- Technique and nutrition specialists, reached from any conversation.
...
- Nutrition, supplements and pharmacology discussed at the level of
  established evidence, never as doses.
